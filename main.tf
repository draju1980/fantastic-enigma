...
resource "aws_security_group" "demo-sg" {
  ...
  dynamic "ingress" {
    for_each = [22, 80, 443, 30303, 30304, 9003, 8545, 8546, 9000, 8547, 12345]
    content {
...
# adding public key to instances authorized_keys file
...
resource "aws_instance" "demo-node" {
  ...
  root_block_device {
    volume_size = 100  # Set this value to your desired size in GB
